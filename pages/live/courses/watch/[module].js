              ...
              <div className="flex flex-col items-center">
                <div className="md:w-3/4 w-full bg-white p-5 flex flex-wrap">
                  <div className="md:w-1/2 md:h-96 h-64 w-full p-2">
                    <ReactPlayer
                      url={moduleArray[moduleNumber].video_link}
                      width="100%"
                      height="100%"
                      controls
                    />
                  ...
                  <div className="md:w-1/2 p-3">
                    <div className="text-2xl text-gray-700 h-1/6">
                      {moduleArray[moduleNumber].title}
                    </div>
                    <div className=" leading-6 text-gray-500 h-5/6 overflow-y-auto text-sm">
                      {moduleArray[moduleNumber].module_text}
                    </div>
                  </div>
                </div>
              </div>
